...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Anniversary Pack Team'],
			['headdzo',		                'gab',		                'Main Director & Artist',							'https://x.com/WhoUsedHeaddzo',           'FFE7C0'],
			['kiwiquest',		                'lex',		                'Director & Composer',							'https://x.com/kiwiquestt',           'FFE7C0'],
			['peni',		                'cold',		                'Director & Programmer',							'https://x.com/cold_vee',           'FFE7C0'],
			['data',		                'data',		                'Director & Programmer',							'https://x.com/_data5',           'FFE7C0'],
			['wrathstetic',		                'wrath',		                'Composer',							'https://x.com/wrathstetic',           'FFE7C0'],
			['redtv53',		                'redtv',		                'Composer',							'https://x.com/RedTv_53',           'FFE7C0'],
			['greggreg',		                'greg',		                'Composer',							'https://x.com/gregnantmen',           'FFE7C0'],
			['yumii',		                'yumii',		                'Artist',							'https://x.com/yumiilicious_',           'FFE7C0'],
			['infry',		                'infry',		                'Artist',							'https://x.com/Infry20',           'FFE7C0'],
			['mabor',		                'maboi',		                'Artist',							'https://x.com/M_boi9798',           'FFE7C0'],
			['lossarquo',		                'loss',		                'Artist',							'https://x.com/lossarquo',           'FFE7C0'],
			['MewMarisa',		                'marissa',		                'Artist',							'https://twitter.com/HSkribble',           'FFE7C0'],
			['rotty',		                'rotty',		                'Charter',							'https://twitter.com/RottySC2',           'FFE7C0'],
			['ruby',		                'brooklyn',		                'Charter & Voice Actor',							'https://twitter.com/Estrogen_Storm',           'FFE7C0'],
			['stuffy',		                'stuffy',		                'Artist',							'https://twitter.com/Trollingmaster_',           'FFE7C0'],
			['Guests'],
			['srife5',		                'ourple',		                'Charter',							'https://x.com/strife55',           'FFE7C0'],
			[''],
			['Anniversary Port'],
			['Peppy',		                'peppy',		                'Main Android Porter',							'https://www.youtube.com/channel/UCmGq-hQDmdYcF26FLBsfwaA',           'FFE7C0'],
			['tedyes',		                'hoovy',		                'Port helper',							'https://www.youtube.com/channel/UC9NfXTQPkh9O9gpIaC9GnKQ',           'FFE7C0'],
			['mcagabe19',		                'lily',		                'Head Porter of Psych Engine Mobile\nIOS Port',							'https://www.youtube.com/@mcagabe19',           'FFE7C0'],
			[''],
			['Mobile Porting Team'],
